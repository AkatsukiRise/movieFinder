...
<template>
    ...
    <div v-if='!movies.length' class='welcome_container'>
      <img src='../../favicon.jpeg' width='64' height='64' class='welcome_icon' alt='icon'>
    ...
    <div v-if='movies.length' class='page_first'>
      <button v-if='page > 1' @click='page = 1' @click.left='SearchMovies' class='page' id='first'>Вернуться на Первую Страницу</button>
    <div  class='page_container'>
      <button
        v-if='page > 1'
        @click='page--; scrollToTop()'
        @click.left='SearchMovies'
        class='page'
      >
        Предыдущая
      </button>
